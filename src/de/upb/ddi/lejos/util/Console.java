...
/**
 * Simple Klasse um Informationen auf dem LCD auszugeben.
 * Die Konsole stellt drei Ausgabeströme zur Verfügung, die es ermöglichen,
 * semantisch getrennte Daten auf dem Display enzuzeigen und die entsprechenden
 * Ströme jederzeit ein- und abzuschalten. Auf deise Weise können zusätzliche
 * Debug-Informationen eingeschaltet, Log-Daten angezeigt oder
 * nur die vom Programm generierten Ausgaben auf dem LCD angezeigt werden.
 * Ausserdem kann die Ausgabe durch einen Hinweiston ergänzt werden.
 * @author Marc Albert <malbert@it.cargotech.com>
 */
public class Console {
     ...
     * diese Ausgabe geschickt werden. Ist zu Beginn aktiv und erzeugt neben
     * dem Nachrichtentext einen Fehlerton.
     */
     ...
     * geben. Ist zu Beginn inaktiv. Im aktiven Fall werden die Nachrichten
     * von einem Hinweiston begleitet.
     */
    ...
    /**
     * Ob die Ausgabe über die {@link RConsole} Klasse
    ...
    public void signal() {
        switch( this.sound ) {
            case SOUND_BEEP: Sound.beep(); break;
            case SOUND_BUZZ: Sound.buzz(); break;
            case SOUND_TWOBEEP: Sound.twoBeeps(); break;
        }
    }
     ...
     * Ausgabegerät anzeigen. Dies ist vor allem für die
     * {@link #dbg Debug-konsole} hilfreich, da diese in der Regel eine große
     * Anzahl Informationen erzeugt, die zum Großteil eher unübersichtlich sind.
     * <p/>
     * Als Ausgabegerät bietet sich ein Computer an, auf dem das von LeJOS
     * mitgelieferte Programm <code>nxjconsole</code> bzw
     * <code>nxjconsoleviewer</code> läuft (zu finden im <em>bin</em> Ordner
     * der LeJOS Installation).
     */
     ...
     * Fall wenn {@link redirect()} aufgerufen wurde und die Verbindung über
     * USB akzeptiert wurde.
     * @see RConsole#isOpen() 
     * @return
     */
